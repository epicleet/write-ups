There were two files in this challange. The data file is made of many big integer numbers. Let's analyze the binary. If we decompile it in pseudocode, it is very easy to understand:
